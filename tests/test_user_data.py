...
def make_gamification(**kwargs):
    ...
    gam.streak_last_date = kwargs.get("streak_last_date", None)
    ...
    gam.daily_quest_id = kwargs.get("daily_quest_id", None)
    gam.daily_quest_date = kwargs.get("daily_quest_date", None)
