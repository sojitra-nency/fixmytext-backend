...
class User(Base):
    ...
    # ── Relationships ──────────────────────────────────────────────────────────
    preferences: Mapped["UserPreferences | None"] = relationship(back_populates="user", cascade="all, delete-orphan")
    ui_settings: Mapped["UserUiSettings | None"] = relationship(back_populates="user", cascade="all, delete-orphan")
    gamification: Mapped["UserGamification | None"] = relationship(back_populates="user", cascade="all, delete-orphan")
