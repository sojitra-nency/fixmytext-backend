...
class Subscription(Base):
    ...
    amount_paid_subunits: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
...
class PaymentEvent(Base):
    ...
    razorpay_event_id: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    razorpay_payment_id: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    razorpay_order_id: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    ...
    amount_subunits: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    currency: Mapped[Optional[str]] = mapped_column(String(10), nullable=True)
