...
def upgrade() -> None:
    ...
    op.create_index('ix_shared_results_user_id', 'shared_results', ['user_id'], schema='activity')
    op.create_index('ix_shared_results_created_at', 'shared_results', ['created_at'], schema='activity')
